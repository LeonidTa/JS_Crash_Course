...
addForm.addEventListener('submit', function(e){
    e.preventDefault();                         //Prevents the default behavior of the "add" button
    const value = addForm.querySelector('input[type="text"]').value;  //getting the text that was written
    console.log(value);
